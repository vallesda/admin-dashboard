...
/**
 * El freno del login del panel.
 *
 * Gemelo del de la tienda, y duplicado por la misma razón que el módulo: son
 * dos despliegues. Lo que se protege aquí es que `/api/auth/*` queda fuera del
 * matcher de `proxy.ts`, así que sin esto el endpoint de credenciales se puede
 * martillear directamente.
 */
